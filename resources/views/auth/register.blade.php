        ...
        <div class="row">
            ...
            <div class="col-lg-7">
                <div class="p-5">
                    ...
                    <form class="user" action="/register" method="POST"> @csrf
                        <div class="form-group">
                            <input type="text" name="nama" class="form-control form-control-user 
                            @error('nama') is-invalid @enderror" id="exampleInputEmail" 
                            value="{{ old('nama') }}"
                        ...
                        <div class="form-group">
                            ...
                            @error('password_confirm') is-invalid @enderror" id="exampleInputPassword" 
